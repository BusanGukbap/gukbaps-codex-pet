...
Run these commands from the `pets/vesper` folder, then copy the package files into your Codex pets directory:

`pets/vesper` 폴더에서 아래 명령을 실행해, 패키지 파일을 Codex 펫 디렉터리에 복사합니다.
